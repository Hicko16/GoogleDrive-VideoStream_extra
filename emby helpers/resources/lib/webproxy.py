        ...
        if re.search(r'/testlock/', str(self.path)):
            ...
            if results:
                ...
                if results:
                    ...
                    request = urllib2.Request(self.server.serverURL + '/emby/Users/'+str(ID)+'/Policy?api_key=' + self.server.key, "{\"IsAdministrator\":false,\"IsHidden\":true,\"IsDisabled\":false,\"EnableLiveTvManagement\":false,\"EnableLiveTvAccess\":true,\"EnableMediaPlayback\":true,\"EnableAudioPlaybackTranscoding\":true,\"EnableVideoPlaybackTranscoding\":false,\"EnablePlaybackRemuxing\":true,\"EnableContentDeletion\":false,\"EnableContentDownloading\":false,\"EnableSyncTranscoding\":false,\"EnableMediaConversion\":false,\"RemoteClientBitrateLimit\":0}",{'Content-Type': 'application/json'})
                    response = urllib2.urlopen(request)
