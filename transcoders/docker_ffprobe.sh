...
echo "  libavfilter     6. 65.100 /  6. 65.100v
echo "  libavresample   3.  1.  0 /  3.  1.  0"
echo "  libswscale      4.  2.100 /  4.  2.100"
echo "  libswresample   2.  3.100 /  2.  3.100v
echo "  libpostproc    54.  1.100 / 54.  1.100v
...
echo "Input #0, hls,applehttp, from 'http://vapi.vaders.tv/play/56686.m3u8?':"
